...
function onCreate()
	...
	makeLuaSprite('tricky-redbg', 'stages/tricky-redbg', -1200, -650);
	setLuaSpriteScrollFactor('tricky-redbg', 0.9);

	makeLuaSprite('tricky-expurgation-energywall', 'stages/tricky-expurgation-energywall', 1200, -200);

	makeLuaSprite('tricky-expurgation-spawnhole-back', 'stages/tricky-expurgation-spawnhole-back', 80, 820);

	makeLuaSprite('tricky-expurgation-spawnhole-cover', 'stages/tricky-expurgation-spawnhole-cover', 30, 845);
	
	makeLuaSprite('tricky-expurgation-back', 'stages/tricky-expurgation-back', -650, -200);

	makeLuaSprite('tricky-expurgation-backcover', 'stages/tricky-expurgation-backcover', -93, 870);
