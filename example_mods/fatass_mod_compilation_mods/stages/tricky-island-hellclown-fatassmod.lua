...
function onCreate()
	...
	makeLuaSprite('tricky-greenbg', 'stages/tricky-greenbg', -1200, -650);
	luaSpriteMakeGraphic('tricky-greenbg', 4000, 2000, '274e13')
	setLuaSpriteScrollFactor('tricky-greenbg', 0.9);
	
	makeLuaSprite('tricky-island-hellclown-fatassmod', 'stages/tricky-island-hellclown-fatassmod', -3400, -800);
