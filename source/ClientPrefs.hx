...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		save.bind('rhythmengine_controls_v3', CoolUtil.getSavePath()); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
