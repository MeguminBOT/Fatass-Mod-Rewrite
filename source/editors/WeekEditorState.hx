...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat("Rubik Medium", 24, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("rubik.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("rubik.ttf");
