...
{
	public static var rhythmVersion:String = '1.0.1'; //This is also used for Discord RPC
	public static var psychEngineVersion:String = '0.6.4b';
	...
	override function create()
	{
		...
		{
			var menuItem:FlxSprite = new FlxSprite(0, (i * 70));
