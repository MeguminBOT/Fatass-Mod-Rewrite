...
class FreeplaySelectState extends MusicBeatState {
	public static var categories:Array<CategoryMetaData> = [
		...
		new CategoryMetaData("fat-ass stuff", 0, "week-fatass-dumbshit", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("various remixes", 0, "face", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("b-sides", 0, "bf-bsides", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("tricky the clown", 0, "tricky-expurgation", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("madness combat stuff", 0, "hank", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("hypno's lullaby", 0, "gold", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("sonic.exe", 0, "sonicexe-fatass", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("graffiti groovin", 0, "skarlet", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("pibby", 0, "corrupted-finn", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("sarvente's mid-fight masses", 0, "sarvente-succubus", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("sky", 0, "sky", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("whitty v1", 0, "whitty-ballistic", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("tabi", 0, "tabi-mad", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("zardy", 0, "zardy", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("impostor", 0, "impostor-green", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("holofunk", 0, "aloe-mano", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("hatsune miku", 0, "hatsune-miku", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("garcello", 0, "garcello", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("starecrown", 0, "starecrown2", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("bob", 0, "bob", FlxColor.fromRGB(255, 0, 0)),
		new CategoryMetaData("osu converts", 0, "osu", FlxColor.fromRGB(255, 0, 0)),
