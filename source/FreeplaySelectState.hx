...
class FreeplaySelectState extends MusicBeatState {
	public static var categories:Array<CategoryMetaData> = [
		...
		new CategoryMetaData("various remixes", 0, "face", FlxColor.fromRGB(160, 160, 160)),
		new CategoryMetaData("b-sides", 0, "bf-bsides", FlxColor.fromRGB(160, 160, 160)),
		new CategoryMetaData("tricky the clown", 0, "tricky-expurgation", FlxColor.fromRGB(160, 160, 160)),
		...
		new CategoryMetaData("whitty v1", 0, "whitty-ballistic", FlxColor.fromRGB(160, 160, 160)),
		...
		new CategoryMetaData("impostor", 0, "impostor-green", FlxColor.fromRGB(160, 160, 160)),
