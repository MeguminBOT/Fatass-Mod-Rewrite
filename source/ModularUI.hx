 ...
 */
class ModularUI extends FlxObject
{
	/**
     ...
     * @param   ScaleX   Desired scale of the rectangle
     * @param   ScaleY   Desired scale of the rectangle
	 */
	public function new(X:Float = 0, Y:Float = 0, Width:Float = 0, Height:Float = 0, ?ScaleX:Float = 0, ?ScaleY:Float = 0)
	{
		super();
